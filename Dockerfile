...
# Copy our patched OAuth Manager to bypass authentication checks
# This is safer than using sed and regex
COPY patched_manager.js ./patched_manager.js
RUN cp ./patched_manager.js node_modules/@suiteinsider/netsuite-mcp/src/oauth/manager.js
